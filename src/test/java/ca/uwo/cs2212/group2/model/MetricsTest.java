...
class MetricsTest {
    ...
    void saveToFileAndLoadFromFile() throws IOException {
        ...
        Assertions.assertEquals(metrics.getTotalNumberOfErrors(), loadedMetrics.getTotalNumberOfErrors());
        Assertions.assertEquals(metrics.getCurrentNumberOfErrors(), loadedMetrics.getCurrentNumberOfErrors());
        Assertions.assertEquals(metrics.getTotalNumberOfAcceptedCorrections(),
                loadedMetrics.getTotalNumberOfAcceptedCorrections());
        Assertions.assertEquals(metrics.getTotalNumberOfManualCorrections(),
                loadedMetrics.getTotalNumberOfManualCorrections());
        Assertions.assertEquals(metrics.getNumberOfWordsInUserDictionary(),
